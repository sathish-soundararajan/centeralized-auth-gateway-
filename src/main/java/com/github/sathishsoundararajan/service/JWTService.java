...
public class JWTService {
	...
	public String createToken(Long userId, String userType, String userRole) {
		final JWTCreator.Builder jwtBuilder = JWT.create().withIssuer(ISSUER_NAME).withSubject(userId.toString())
				.withClaim(USER_ID_CLAIM, userId).withIssuedAt(new Date()).withClaim(USER_TYPE_CLAIM, userType)
