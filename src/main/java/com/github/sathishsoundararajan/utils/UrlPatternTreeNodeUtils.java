package com.github.sathishsoundararajan.utils;
...
public class UrlPatternTreeNodeUtils {
	...
	public static void addUrlNode(String url, List<String> userRoleClaim, String urlClaim,
			UrlPatternTreeNode currentNode) {
